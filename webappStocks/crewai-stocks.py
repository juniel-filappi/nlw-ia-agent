...
yahoo_finance_tool = Tool(
    ...
    description = "Fetches stocks prices for (ticket) from the last year about a specifit stock from Yahoo Finance API",
...
stockPriceAnalyst = Agent(
    ...
    backstory="""You're a highly experienced in analyzing the price of and specifit stock 
...
stockAnalystWrite = Agent(
    ...
    goal="""Analyze the trends price and news and write an insighfull an compelling and informative 3 paragraph long newsletter based on the stock report and price trend.""",
